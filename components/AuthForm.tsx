...
const AuthForm = ({ onSuccess, isNavigating = false }: AuthFormProps) => {
    ...
    <div className="flex flex-col gap-6 p-8 pt-10">
      ...
      <div className="w-full flex flex-col gap-4 mt-2">
        <Button 
          type="button" 
          variant="outline" 
          className="w-full relative bg-transparent border-white/10 hover:bg-white/5 transition-colors text-white h-11"
